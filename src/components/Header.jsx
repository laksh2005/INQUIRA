    ...
    <div className="bg-black flex justify-between m-0 z-30 relative">
      ...
      <div className="flex items-center font-sans">
        <ul className="flex p-4 m-4 space-x-8 items-center justify-center">
          ...
          <li className="px-4 text-white font-bold hover:bg-gradient-to-r from-custom1 to-custom2 hover:text-black rounded-full transition duration-300 ease-in-out"><Link to='/chatbot'>INQUIRA </Link></li>
